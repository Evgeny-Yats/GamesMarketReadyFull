    ...
    <div class="products-columns">
        @foreach($productsPagination->itemsOnPage as $product)
            <div class="products-columns__item">
                ...
                <div class="products-columns__item__description"><span class="products-price">{{$product->price}} руб</span><a href="{{route('cart.add', ['product_id' => $product->id])}}" class="btn-buy">Купить</a></div>
            </div>
        @endforeach
    </div>
@endsection
