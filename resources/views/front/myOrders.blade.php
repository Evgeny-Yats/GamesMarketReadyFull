        ...
        @foreach($orderPositionsPagination->itemsOnPage as $orderPosition)
            <div class="cart-product-list__item">
                ...
                <div class="cart-product__item__product-name">
                    <div class="cart-product__item__product-name__content"><a href="{{route('product', ['product_id' => $orderPosition->product_id])}}" class="myOrderA">{{$orderPosition->product()->withTrashed()->first()->name}}</a></div>
                </div>
